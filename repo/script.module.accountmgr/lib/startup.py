...
def check_api():
        while True:
                ...
                if control.setting('api.service')=='true' and xbmcvfs.exists(var.chk_nxtflix) and xbmcvfs.exists(var.chkset_nxtflix) and str(var.chk_accountmgr_tk) != '':
                        try:
                ...
                '''if control.setting('api.service')=='true' and xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix) and str(var.chk_accountmgr_tk) != '':
                        try:
...
def restore_api():
        ...
        if xbmcvfs.exists(var.chk_nxtflix):
            try:
                ...
                xbmc.log('%s: Restore API NXTFlix' % var.amgr, xbmc.LOGINFO)
