...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('nxtflixlt.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('nxtflixlt.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('nxtflixlt.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('nxtflixlt.%s' % setting)])

def set_string(params):
	current_value = get_setting('nxtflixlt.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('nxtflixlt.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('nxtflixlt.%s' % setting_id)
...
def default_setting_values(setting_id):
	if 'nxtflixlt.' in setting_id: setting_id = setting_id.replace('nxtflixlt.', '')
	d_settings = default_settings()
...
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'blry12.github.io/nxtflix'},
#==================== Watched Indicators
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlt/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlt/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlt/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlt/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': '422a282ef5fe4b5c47bc60425c009ac3047ebd10a7f6af790303875419f18f98'},
#==================== TMDb API
{'setting_id': 'tmdb_api', 'setting_type': 'string', 'setting_default': '76067629fab243b989a68881eb1f63ef'},
#==================== TMDb Lists
