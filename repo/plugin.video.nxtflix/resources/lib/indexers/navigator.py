...
class Navigator:
	...
	def folder_navigator(self):
		...
		def _process():
			for info in results:
				try:
					...
					linked_folder = test_assigned_content('NXTFlix_FOLDERS_%s' % link_id, assigned_content)
		...
		assigned_content = gather_assigned_content("'NXTFlix_FOLDERS_%s" % setting_id + "_%'")
