...
OFFCID = {
    'nxtflixlt': {
        ...
        'file'     : os.path.join(CONFIG.OFFCFOLD, 'nxtflixlt_offc'),
...
def offc_user(who):
    ...
    if OFFCID[who]:
       ...
       if os.path.exists(OFFCID[who]['path']) and name == 'NXTFlix Light':
           try:
               ...
               xbmc.log('%s: Offcit NXTFlix Light Failed!' % var.amgr, xbmc.LOGINFO)
               pass
       else:
