...
EDID = {
    'nxtflixlt': {
        ...
        'file'     : os.path.join(CONFIG.EDFOLD, 'nxtflixlt_ed'),
...
def ed_user(who):
    ...
    if EDID[who]:
       name = EDID[who]['name']
       if os.path.exists(EDID[who]['path']) and name == 'NXTFlix Light':
           try:
               ...
               xbmc.log('%s: Edit NXTFlix Light Failed!' % var.amgr, xbmc.LOGINFO)
               pass
       else:
