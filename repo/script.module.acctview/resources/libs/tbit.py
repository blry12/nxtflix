...
TBID = {
    'nxtflixlt': {
        ...
        'file'     : os.path.join(CONFIG.TBFOLD, 'nxtflixlt_tb'),
...
def tb_user(who):
    ...
    if TBID[who]:
       name = TBID[who]['name']
       if os.path.exists(TBID[who]['path']) and name == 'NXTFlix Light':
           try:
               ...
               xbmc.log('%s: Tbit NXTFlix Light Failed!' % var.amgr, xbmc.LOGINFO)
               pass
       else:
