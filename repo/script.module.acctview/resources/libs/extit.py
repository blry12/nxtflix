...
EXTID = {
    'nxtflix': {
        ...
        'file'     : os.path.join(CONFIG.EXTFOLD, 'nxtflix_ext'),
    ...
    'nxtflixlt': {
        ...
        'file'     : os.path.join(CONFIG.EXTFOLD, 'nxtflixlt_ext'),
...
def ext_user(who):
    ...
    if EXTID[who]:
        name = EXTID[who]['name']
        if os.path.exists(EXTID[who]['path']) and name == 'NXTFlix Light':
            try:
                ...
                xbmc.log('%s: Extit NXTFlix Light Failed!' % var.amgr, xbmc.LOGINFO)
                pass
            '''elif os.path.exists(ExtID[who]['path']) and name == 'afnxtflixity':
            try:
                ...
                xbmc.log('%s: Extit afnxtflixity Failed!' % var.amgr, xbmc.LOGINFO)
                pass'''
        else:
