...
class Router:
    ...
    def dispatch(self, handle, paramstring):
        ...
        elif mode == 'opensettings_nxtflixlt':  # Open NXTFlix Light settings
            var.open_settings_nxtflixlt()
            xbmc.executebuiltin('Container.Refresh()')
        ...
        # TRAKT MANAGER
            ...
            if xbmcvfs.exists(var.chk_nxtflixlt) and xbmcvfs.exists(var.chkset_nxtflixlt):
                ...
                #databit.backup_afnxtflix_trakt()
            ...
            try:
                if xbmcvfs.exists(var.trakt_backup): # Skip restore if no trakt folder present in backup folder
                    ...
                    if len(path) != 0: # Skip restore if no saved data in backup folder
                        ...
                        if xbmcvfs.exists(var.chk_nxtflixlt) or xbmcvfs.exists(var.chk_dradis) or xbmcvfs.exists(var.chk_genocide):
            ...
            #if xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix):
                #databit.revoke_afnxtflix_trakt()
                #var.remake_settings() #Refresh settings database
            ...
            if xbmcvfs.exists(var.chk_nxtflix):
                try:
                    ...
                    xbmc.log('%s: Traktit.py Revoke API NXTFlix' % var.amgr, xbmc.LOGINFO)
                    pass
                ...
                if xbmcvfs.exists(var.easy_backup): # Skip restore if no easynews folder present in backup folder
                    ...
                    if len(path) != 0: # Skip restore if no saved data in backup folder
                        ...
                        if xbmcvfs.exists(var.chk_nxtflixlt) and xbmcvfs.exists(var.chkset_nxtflixlt):
                            ...
                            var.remake_settings() #Refresh settings database
                        #if xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix):
                            #databit.restore_afnxtflix_easy()
                            #var.remake_settings() #Refresh settings database
        ...
        #EXTERNAL PROVIDERS MANAGER
            ...
            if xbmcvfs.exists(var.chk_nxtflixlt) and xbmcvfs.exists(var.chkset_nxtflixlt):
                databit.backup_nxtflixlt_ext()
            #if xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix):
                #databit.backup_afnxtflix_ext()
            ...
            try:
                if xbmcvfs.exists(var.ext_backup): # Skip restore if no extprovider folder present in backup folder
                    ...
                    if len(path) != 0: # Skip restore if no saved data in backup folder
                        ...
                        if xbmcvfs.exists(var.chk_nxtflixlt) and xbmcvfs.exists(var.chkset_nxtflixlt):
                            databit.restore_nxtflixlt_ext()
                            xbmc.executebuiltin('Dialog.Close(all,true)')
                            xbmc.sleep(1000)
                            var.remake_settings() #Refresh settings database
                        #if xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix):
                            #databit.restore_afnxtflix_ext()
                            #var.remake_settings() #Refresh settings database
            ...
            if xbmcvfs.exists(var.chk_nxtflixlt) and xbmcvfs.exists(var.chkset_nxtflixlt):
                databit.revoke_nxtflixlt_ext()
                xbmc.executebuiltin('Dialog.Close(all,true)')
                xbmc.sleep(1000)
                var.remake_settings() #Refresh settings database
            #if xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix):
                #databit.revoke_afnxtflix_ext()
                #var.remake_settings() #Refresh settings database
                ...
                if xbmcvfs.exists(var.meta_backup): # Skip restore if no meta folder present in backup folder
                    ...
                    if len(path) != 0: # Skip restore if no saved data in backup folder
                        ...
                        if xbmcvfs.exists(var.chk_nxtflixlt) and xbmcvfs.exists(var.chkset_nxtflixlt):
                            ...
                            var.remake_settings() #Refresh settings database
                        #if xbmcvfs.exists(var.chk_afnxtflix) and xbmcvfs.exists(var.chkset_afnxtflix):
                            #databit.restore_afnxtflix_meta()
                            #var.remake_settings() #Refresh settings database
