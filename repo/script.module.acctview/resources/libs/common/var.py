...
nxt = xmls + translatePath('plugin.video.nxt/settings.xml')
...
chk_nxt = addons + translatePath('plugin.video.nxt/')
...
nxt_ud = addon_data + translatePath('plugin.video.nxt/')
...
chkset_nxt = addon_data + translatePath('plugin.video.nxt/settings.xml')
...
path_nxt = addons + translatePath('plugin.video.nxt/resources/lib/apis/trakt_api.py')
...
nxt_client = '3a69ec1b3b579246dbd6a2d53f49d6b5f227d82d75fe048c1c6ea684a3668ebc'
nxt_secret = 'e98253e2f69c2a72a401af82059c866bfa0853bbc2d27a01869537981295d388'
...
nxt_fan = 'fa836e1c874ba95ab08a14ee88e05565'
nxt_tmdb = 'b370b60447737762ca38457bd77579b3'
