...
def import_easynews():
	...
	# if get_setting('nxtflixlight.easynews.api_version') == '0': return EasyNewsAPI()
...
class EasyNewsAPI:
	def __init__(self):
		...
		self.username = get_setting('nxtflixlight.easynews_user', 'empty_setting')
		self.password = get_setting('nxtflixlight.easynews_password', 'empty_setting')
