...
tmdb_default_api, _id, _secret = kodi_utils.tmdb_default_api, kodi_utils._id, kodi_utils._secret
...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('nxtflixlight.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		set_property('nxtflixlight.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('nxtflixlight.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('nxtflixlight.%s' % setting)])

def set_string(params):
	current_value = get_setting('nxtflixlight.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('nxtflixlight.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('nxtflixlight.%s' % setting_id)
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_nxtflixlight', 'setting_type': 'boolean', 'setting_default': 'false'},
...
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': 'blry12'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'blry12.github.io'},
#==================== Watched Indicators
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlight/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlight/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlight/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.nxtflixlight/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': _id},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': _secret},
#==================== TMDb
