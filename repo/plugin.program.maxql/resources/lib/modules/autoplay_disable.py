...
class ap_disable:
    def disable():
        ...
        try:
            addon = xbmcvfs.translatePath('special://home/addons/plugin.video.thelabjr/')
            file = xbmcvfs.translatePath('special://userdata/addon_data/plugin.video.thelabjr/settings.xml')
