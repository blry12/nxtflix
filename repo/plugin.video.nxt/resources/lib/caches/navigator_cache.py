...
prop_dict = {'default': 'nxt_%s_default', 'edited': 'nxt_%s_edited', 'shortcut_folder': 'nxt_%s_shortcut_folder'}
timeout = 60
...
main_menu_items = {'RootList': {'name': 32457, 'iconImage': 'nxt', 'mode': 'navigator.main', 'action': 'RootList'},
